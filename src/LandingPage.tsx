                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-20">
                        ...
                        <div className="hidden md:flex items-center space-x-8">
                            ...
                            <button className="bg-azure-blue text-white px-6 py-3 rounded-2xl font-medium hover:bg-blue-600 transition-all shadow-lg hover:shadow-xl hover:shadow-azure-blue/30">
                                Agendar Demo
                            </button>
                        </div>
                        ...
                        <div className="md:hidden">
                            <button className="bg-azure-blue text-white px-4 py-2 rounded-2xl font-medium text-sm shadow-lg">
                                Agendar Demo
                            </button>
                        </div>
                    </div>
