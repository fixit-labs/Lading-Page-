...
const LandingPage = () => {
    ...
    return (
        <div className="bg-white">
            ...
            {/* Hero Section */}
            <section className="min-h-screen flex items-center px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-black to-[#082340] pt-24 sm:pt-28 pb-12">
                <div className="max-w-7xl mx-auto w-full py-8">
                    <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                        ...
                        >
                            ...
                            {/* Chatting Man Image - Overlaid Right */}
                            <img
                                src="/images/hero-chating-man.webp"
                                alt="Man using phone"
                                className="absolute bottom-[-21.2vh] -right-40 h-[95%] sm:h-[170%] w-auto z-30 pointer-events-none"
                            />
                        </motion.div>
                    </div>
                </div>
